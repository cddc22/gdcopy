...
const DEFAULT_TARGET = '0AIESuAP58J4jUk9PVA' // 必填，拷贝默认目的地ID，如果不指定target，则会复制到此处，建议填写团队盘ID

const AUTH = { // 如果您拥有service account的json授权文件，可将其拷贝至 sa 目录中以代替 client_id/secret/refrest_token
  client_id: '317298054619-223t27vferhtdm5vko2tcgrk5j3os4ar.apps.googleusercontent.com',
  client_secret: 'ntsC3e76FOaDzdeBS8RLrolN',
  refresh_token: '1//0eeH7XoBe2RCMCgYIARAAGA4SNwF-L9IrzQEIhwFNyIlD2t15w1Y9FOHOOGSbGGJxX3o6UPq2uKHiaRFCAUG_9mWLWL46VhFq-8g',
  expires: 0, // 可以留空
  access_token: '', // 可以留空
